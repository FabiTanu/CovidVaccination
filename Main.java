...
public class Main {
                ...
                if (arr[i].gender.equals("female")) {
                    ...
                    if (str.equals("yes")) {
                        ...
                        if (str1.equals("yes")) {
                            ...
                            System.out.println("\t\t\tSylhet M.A.G. Osmani Medical College, \n\t\t\tSylhet Women's Medical College, \n\t\t\tNorth East Medical College and Hospital");
                            System.out.print("\t\t\tType---------> ");
    ...
    static void vaccination() {
        ...
        System.out.println("||--------------------------------------------------||");
        try {
            Scanner read = new Scanner(new FileReader("C:\\Setup\\CovidVaccinationManagementSystem\\src\\CovidVaccination\\Vaccine.txt"));
    ...
    static void seeVaccination() {
        ...
        try {
            FileInputStream fis = new FileInputStream("C:\\Setup\\CovidVaccinationManagementSystem\\src\\CovidVaccination\\Vaccine.txt");
    ...
    static void saveFile() {
        for (int i = 0; i < arr.length; i++) {
            if (arr[i].vacc != null && arr[i].hos != null) {
                try {
                    FileOutputStream file = new FileOutputStream("C:\\Setup\\CovidVaccinationManagementSystem\\src\\CovidVaccination\\Vaccine.txt");
